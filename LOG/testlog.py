...
class InfoLog(object):
    def __init__(self,page_name):
        self.my_log = LogManager(page_name).get_logger_and_add_handlers(log_level_int=20,log_path="../LOG/", log_filename="my_log.log")

    def  WriteLogtoFile(self,info):
        self.my_log.info(info+"\n")

class ErrorLog(object):
    def __init__(self, page_name):
        self.my_logs = LogManager(page_name).get_logger_and_add_handlers(log_level_int=40, log_path="../LOG/",log_filename="my_log.log")


    def WriteLogtoFile(self, info):
        self.my_logs.error(info+"\n")
    ...
    #     my_log = LogManager("fm").get_logger_and_add_handlers(log_level_int=20,log_path=".", log_filename="my_log.log")
    #     """
